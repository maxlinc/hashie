  ...
  describe 'properties' do
    it 'rejects reserved words' do
      ...
      reserved_names.each do | name |
        expect { klass.property name }.to raise_error, "Did not reject reserved word #{name}"
        expect { klass.property name.to_sym }.to raise_error, "Did not reject reserved word #{name.to_sym}"
      end
    end
